...
class MatrixTrain(MatrixBase):
    def __init__(self, **kwargs):
        super().__init__(txt_file="data/Matrixv1512/Matrix_512_train.txt", 
                         data_root="Matrix_512/train", 
                         **kwargs)


class MatrixVal(MatrixBase):
    def __init__(self, flip_p=0., **kwargs):
        super().__init__(txt_file="data/Matrixv1512/Matrix_512_val.txt", 
                         data_root="Matrixv1/Matrix_512/val",
